...
const Contact = ({sendEmail}) => {
    ...
    const [disable,setable] = useState(1)
        ...
        <div  className='flex flex-col p-4 justify-center  max-w-screen-lg mx-20 h-full'>
            ...
            <div className='flex flex-col justify-center items-center'>
                <form  className='flex flex-col w-full md:w-1/2' onSubmit={sendEmail}>
                    ...
                    <button className={'text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto flex itexm-center rounded-md hover:scale-110 duration-300 '+a[disable]} onClick={()=>valueChange()}>Let's talk</button>
                    <TiTickOutline  className={'mx-auto h-20 w-20 bg-green-500 rounded-full my-5 '+b[disable]}/>
                </form>
            </div>
         </div>
        <div>
